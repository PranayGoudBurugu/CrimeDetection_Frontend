        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-serif font-bold tracking-tight text-white">
              Mudra <span className="text-indigo-400">Analysis</span>
            </h1>
          </div>
        </div>
          ...
          <div className="w-full h-full max-w-5xl max-h-[80vh] flex flex-col">
            ...
            {!videoFile && !errorMsg && (
              <div className="mt-6 flex items-start gap-3 p-4 bg-indigo-900/10 border border-indigo-500/20 rounded-lg max-w-2xl mx-auto">
                ...
                <div>
                  <h4 className="text-indigo-300 font-medium text-sm mb-1">
                    Instructions
                  </h4>
                  <p className="text-gray-400 text-xs leading-relaxed">
                    Upload a 15-second video clip of Indian Classical Dance. The
                    AI will analyze the visual stream to detect hand gestures
                    (Mudras) and facial expressions (Abhinaya) frame-by-frame.
                  </p>
                </div>
              </div>
            )}
