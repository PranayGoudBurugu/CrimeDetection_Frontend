    ...
    <div className="h-full flex flex-col bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden min-h-0">
        ...
        <div className="flex-1 flex flex-col p-2 sm:p-3 lg:p-4 min-h-0">
          <div className="flex-1 bg-background rounded-lg overflow-hidden flex items-center justify-center shadow-xl border-2 border-border min-h-[200px] sm:min-h-[300px] lg:min-h-0">
            <VideoPlayer
              videoFile={videoFile}
          ...
          {errorMsg && (
            <div className="mt-3 p-3 bg-destructive/10 rounded-md border border-destructive text-destructive text-xs font-medium">
              {errorMsg}
            </div>
          )}
        </div>
